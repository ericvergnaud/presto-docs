export default function Overview() {
	return (
		<li>
            ...
            <h3>Build and run in the cloud</h3>
            ...
            <h3>Interpreted <i>and</i> compiled</h3>
            ...
            <table className="uk-table uk-table-small uk-text-small uk-table-striped uk-table-hover uk-margin-medium-top">
                <thead>
                    <tr>
                        <th>Language</th>
                        <th>Interpreter</th>
            ...
            <h3>Statically inferred types</h3>
            ...
            <h3>Global and dynamic polymorphic methods</h3>
            ...
            <h3>Prompto dialects: syntax is a detail</h3>
