export default function Dialects() {
    ...
    print("= 28.5");
            ...
            <pre><code>{`def main(options:Text<:>):
    print("15 + 3.5")
    print("= 28.5")`}</code></pre>
            <p/>
            <h3>The Engly dialect aka "E"</h3>
            ...
            <pre><code>{`define main as method doing:
    print "15 + 3.5"
    print "= 28.5"`}</code></pre>
            <p/>

            <h3>Seamless translation between dialects</h3>
