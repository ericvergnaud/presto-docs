export default function Download(props) {
    ...
    return (
            <article className="download" style={divStyle}>
                ...
                <p>If you don't already have Docker unstalled, you can <a href="https://www.docker.com/products/docker-desktop" target="_blank" rel="noreferrer">download it for free from here.</a></p>
                <p>Once you have Docker installed, <a href="https://raw.githubusercontent.com/prompto/prompto-docker/master/install_prompto_macosx.sh" target="_blank" rel="noreferrer">download the Prompto installer.</a></p>
