    ...
    renderContent(topicSelected) {
        return <>
            ...
            <p>CSS stands for <b>C</b>ascading <b>S</b>tyle <b>S</b>heet.
                ...
                A CSS literal is a sequence of 1 or more CSS entries, separated by semi-colons.</p>
...
{ display: { <i>some_value</i> }; } -> a CSS literal, where the <i>value</i> for the <i>display</i> property is an expression evaluated at runtime
{ width: { <i>some_value</i> }px; } -> a CSS literal, where the <i>value</i> for the <i>width</i> property is determined at runtime`}</pre>
