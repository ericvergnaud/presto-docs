			...
			<div className="uk-container uk-container-large">
				<div className="uk-grid-medium uk-child-width-1-2@s" data-uk-grid>
					<div>
						...
						<h4 className="uk-margin-large-top">Prompto frees you from time consuming tasks<br />and lets you focus on making visible differences : <br /> creative web pages, meaningful data models and relevant business logic</h4>

						<div className="uk-flex uk-margin-large-top">
							<a href="#getting-started" className="uk-button uk-button-secondary p-primary uk-box-shadow-medium uk-margin-medium-right" data-uk-scroll>
