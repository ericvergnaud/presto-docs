...
class ThisTopic extends Topic {
    ...
    renderContent(topicSelected) {
        return <React.Fragment>
            ...
            <PromptoPlayer lines={10} sampleUrl="samples/types/methods/overloaded-count.pec" runnable={true}/>
            <p/>
            ...
            <PromptoPlayer lines={10} sampleUrl="samples/types/methods/overloaded-type.pec" runnable={true}/>
            </React.Fragment>;
    }
