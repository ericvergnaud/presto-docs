...
class ThisTopic extends Topic {
    ...
    renderContent(topicSelected) {
        return <React.Fragment>
                ...
                <PromptoPlayer lines={20} sampleUrl="samples/types/methods/abstract.pec" runnable={true}/>
                <p/>

                <h3><i>Abstract</i> methods as arguments</h3>
                <p>Abstract methods can also be used as arguments for other methods:</p>
                <PromptoPlayer lines={12} sampleUrl="samples/types/methods/abstractArgument.pec" runnable={true}/>
