...
class ThisTopic extends Topic {
    ...
    renderContent(topicSelected) {
        return <React.Fragment>
            ...
            <PromptoPlayer lines={8} sampleUrl="samples/categories/extend-simple.pec"/>
            <br/>
            ...
            <PromptoPlayer lines={16} sampleUrl="samples/categories/extend-usage.pec" runnable={true}/>
            <br/>
            ...
            <p/>
            <PromptoPlayer lines={14} sampleUrl="samples/categories/extend-multi.pec"/>
            ...
            <PromptoPlayer lines={20} sampleUrl="samples/categories/extend-diamond.pec" runnable={true}/>
            <br/>
